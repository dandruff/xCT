...
L["Formatting of criticals"] = "爆击格式"
L["Frame Alpha"] = "框体透明度"
...
L["Merge-Interval for Reputation"] = "声誉合并间隔"
...
L["The interval (seconds) in which reputation gains / losses are merged together. Use 0 to disable."] = "声誉收益/损失合并的间隔（秒）。使用 0 表示禁用。"
