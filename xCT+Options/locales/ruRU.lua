...
L["Enable this option if you have problems with 'floating' icons."] = "Включите эту опцию, если у вас проблемы с 'плавающими' иконками."
...
L["Filters"] = "Фильтры"
L["Floating Combat Text"] = "Плавающий боевой текст"
...
L["The following settings allow you to tweak Blizzard's Floating Combat Text."] = "Следующие настройки позволяют настроить плавающий боевой текст Blizzard."
